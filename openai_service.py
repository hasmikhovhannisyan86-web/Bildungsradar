...
Extrahiere die Informationen als JSON mit den Feldern: offerings, prices, specializations, age_groups, opening_hours, group_size, rating (Bewertung als Zahl 1.0-5.0 falls erwaehnt), summary.
Wenn eine Information nicht verfuegbar ist, verwende 'Keine Angabe'."""
    },
...
3. Suche nach Preisinformationen oder Kostenhinweisen.
...
{{
    ...
    "prices": "Preisbereich oder 'Keine Angabe'",
    ...
    "group_size": "Gruppengroesse oder 'Keine Angabe'",
    "rating": "Bewertung als Zahl (1.0-5.0) falls auf der Webseite erwaehnt, sonst 'Keine Angabe'",
